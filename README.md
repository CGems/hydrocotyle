...
./target/debug/hydrocotyle \
  ...
  --name AlicesNode
```
When the node starts you should see output with "Local node identity" like this: 
```
...
./target/debug/hydrocotyle \
  ...
  --validator \
  --name BobsNode \
  --bootnodes /ip4/0.0.0.0/tcp/30333/p2p/QmchUYAdZGXqq6BTEc8tr6jnSzUYdDWdcfp2V9hMy4BACH
```
