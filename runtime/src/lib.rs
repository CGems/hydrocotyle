...
use runtime_primitives::{
	...
	traits::{self, NumberFor, BlakeTwo256, Block as BlockT, StaticLookup, Verify, Convert}
};
use client::{
...
pub const VERSION: RuntimeVersion = RuntimeVersion {
	spec_name: create_runtime_str!("hydrocotyle"),
	impl_name: create_runtime_str!("hydrocotyle"),
	authoring_version: 3,
	spec_version: 3,
	impl_version: 0,
...
construct_runtime!(
		...
		UncheckedExtrinsic = UncheckedExtrinsic
	{
		...
		Example: example::{Module, Call, Storage, Event<T>},
	}
);
